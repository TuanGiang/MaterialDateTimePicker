package com.wdullaer.materialdatetimepicker.lunar;
 ...
 * Created by: giang.nt on 9:30 AM - 5/4/2018
 * Email: giang.nt@aris-vn.com
 * Location: com.wdullaer.materialdatetimepicker.lunar - LunarSolarConverter
 */
public class LunarSolarConverter {
    ...
    public static Lunar SolarToLunar(int solarDay, int solarMonth, int solarYear) {
        Lunar lunar = new Lunar();
        int index = solarYear - solar_1_1[0];
        int data = (solarYear << 9) | (solarMonth << 5)
                | (solarDay);
        int solar11 = 0;
        ...
        long offset = SolarToInt(solarYear, solarMonth,
                solarDay) - SolarToInt(y, m, d);
